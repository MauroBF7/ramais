...
@section('content')
  <div class="card">
    <div class="card-header h4">
      ...
      Solicitação de alterações para o registro nº {{$telefone->id}}
    </div>
    <div class="card-body">
        <div class="mx-auto p-2" style="width: 500px;">
            <form action="{{ route('telefones.envio',['telefone'=>$telefone]) }}" method="post">
                @csrf
                @method('POST')
               ...
               {{-- <input type="text" name="enderecos_id" style="border-radius: 15px" value="{{old('enderecos_id', $telefone->enderecos_id)}}"> <br /><p> --}}
                ...
                <button type="submit" name="butao" class="btn btn-primary" style="border-radius: 25px">Solicitar Alterações</button>
